#### stacked bar for all seasons by TP wet year
...
for (seasonIndex in c("Summer", "Autumn", "Winter", "Spring")){ 
  ...
  p<-ggplot(data = dfSeason,
    ...
    labs(
      x = 'Trading Period',
      y = 'Ratio', 
      title = 'Generation Per Trading Period In 2020, (Dry)',
  ...
  ggsave(paste0(pPathFiltered, 'StackedBarbyTP', seasonIndex, '2020 Dry year.png'))
